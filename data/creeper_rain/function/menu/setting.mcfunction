...
tellraw @s {"text":"  [修改creeper雨的生成半径]","color":"aqua","hoverEvent": {"action": "show_text","value":"\u00A7d请在\"value\":后的双引号内键入数值\u00A7b \n(示例:20 x的随机值区间为-20..20 z的随机值区间为-20..20)"},"clickEvent": {"action": "suggest_command","value": "/function creeper_rain:setting/set_distance {\"value\":\"\"}"}}
tellraw @s {"text":"  [修改creeper雨的生成高度]","color":"aqua","hoverEvent": {"action": "show_text","value":"\u00A7d请在\"value\":后的双引号内键入数值\u00A7b \n(示例:64为在固定在y=64位置生成,~64为相对玩家所在y轴坐标+64生成)"},"clickEvent": {"action": "suggest_command","value": "/function creeper_rain:setting/set_y {\"value\":\"\"}"}}
